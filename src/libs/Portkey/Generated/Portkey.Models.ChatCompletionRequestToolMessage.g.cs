...
namespace Portkey
{
    ...
    public sealed partial class ChatCompletionRequestToolMessage
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Portkey.JsonConverters.ChatCompletionRequestToolMessageRoleJsonConverter))]
        public global::Portkey.ChatCompletionRequestToolMessageRole Role { get; set; }
