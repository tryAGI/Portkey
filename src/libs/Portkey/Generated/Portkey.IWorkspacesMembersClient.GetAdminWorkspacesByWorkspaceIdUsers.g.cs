...
namespace Portkey
{
    public partial interface IWorkspacesMembersClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Portkey.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Portkey.AutoSDKHttpResponse<global::Portkey.WorkspaceMemberList>> GetAdminWorkspacesByWorkspaceIdUsersAsResponseAsync(
            string workspaceId,
            double? currentPage = default,
            double? pageSize = default,
            global::Portkey.GetAdminWorkspacesUsersRole? role = default,
