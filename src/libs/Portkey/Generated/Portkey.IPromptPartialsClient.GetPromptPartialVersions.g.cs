...
namespace Portkey
{
    public partial interface IPromptPartialsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Portkey.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Portkey.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::Portkey.PromptPartialVersion>>> GetPromptPartialVersionsAsResponseAsync(
            string promptPartialId,
            global::Portkey.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default);
    }
