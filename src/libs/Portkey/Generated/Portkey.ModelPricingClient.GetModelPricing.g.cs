...
namespace Portkey
{
    public partial class ModelPricingClient
    {
        ...
        private static readonly global::Portkey.EndPointSecurityRequirement[] s_GetModelPricingSecurityRequirements =
            new global::Portkey.EndPointSecurityRequirement[]
            {                s_GetModelPricingSecurityRequirement0,
            };
        ...
        public async global::System.Threading.Tasks.Task<global::Portkey.ModelPricingConfig> GetModelPricingAsync(
            string provider,
            string model,
            global::Portkey.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetModelPricingAsResponseAsync(
                provider: provider,
                model: model,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Portkey.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Portkey.AutoSDKHttpResponse<global::Portkey.ModelPricingConfig>> GetModelPricingAsResponseAsync(
            string provider,
            string model,
            global::Portkey.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Portkey.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetModelPricingSecurityRequirements,
                operationName: "GetModelPricingAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Portkey.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Portkey.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetModelPricingAsync",
                                pathTemplate: "$\"/model-configs/pricing/{provider}/{model}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Portkey.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 404)
                            {
                                ...
                                global::Portkey.GetModelPricingResponse? __value_404 = null;
                                try
                                {
                                ...
                                throw global::Portkey.ApiException<global::Portkey.GetModelPricingResponse>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Portkey.ModelPricingConfig.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Portkey.AutoSDKHttpResponse<global::Portkey.ModelPricingConfig>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Portkey.ModelPricingConfig.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
