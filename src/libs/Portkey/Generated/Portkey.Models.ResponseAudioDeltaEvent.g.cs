...
namespace Portkey
{
    ...
    public sealed partial class ResponseAudioDeltaEvent
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Portkey.JsonConverters.ResponseAudioDeltaEventTypeJsonConverter))]
        public global::Portkey.ResponseAudioDeltaEventType Type { get; set; }
