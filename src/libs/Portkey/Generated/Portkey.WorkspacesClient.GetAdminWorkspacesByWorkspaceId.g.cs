...
namespace Portkey
{
    public partial class WorkspacesClient
    {
        ...
        private static readonly global::Portkey.AutoSDKServer[] s_GetAdminWorkspacesByWorkspaceIdServers = new global::Portkey.AutoSDKServer[]
        ...
        private static readonly global::Portkey.EndPointSecurityRequirement s_GetAdminWorkspacesByWorkspaceIdSecurityRequirement0 =
        ...
        private static readonly global::Portkey.EndPointSecurityRequirement[] s_GetAdminWorkspacesByWorkspaceIdSecurityRequirements =
            new global::Portkey.EndPointSecurityRequirement[]
            {                s_GetAdminWorkspacesByWorkspaceIdSecurityRequirement0,
            };
        partial void PrepareGetAdminWorkspacesByWorkspaceIdArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string workspaceId);
        partial void PrepareGetAdminWorkspacesByWorkspaceIdRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string workspaceId);
        partial void ProcessGetAdminWorkspacesByWorkspaceIdResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetAdminWorkspacesByWorkspaceIdResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Portkey.WorkspaceWithUsers> GetAdminWorkspacesByWorkspaceIdAsync(
            string workspaceId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Portkey.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Portkey.AutoSDKHttpResponse<global::Portkey.WorkspaceWithUsers>> GetAdminWorkspacesByWorkspaceIdAsResponseAsync(
            string workspaceId,
            global::Portkey.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Portkey.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetAdminWorkspacesByWorkspaceIdSecurityRequirements,
                operationName: "GetAdminWorkspacesByWorkspaceIdAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            var __pathBuilder = new global::Portkey.PathBuilder(
                                ...
                                servers: s_GetAdminWorkspacesByWorkspaceIdServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetAdminWorkspacesByWorkspaceIdRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Portkey.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Portkey.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "getAdminWorkspacesByWorkspaceId",
                                methodName: "GetAdminWorkspacesByWorkspaceIdAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetAdminWorkspacesByWorkspaceIdResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Portkey.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetAdminWorkspacesByWorkspaceIdResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Portkey.WorkspaceWithUsers.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Portkey.AutoSDKHttpResponse<global::Portkey.WorkspaceWithUsers>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Portkey.WorkspaceWithUsers.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
