...
namespace Portkey
{
    ...
    public sealed partial class PromptPartialsSourceGenerationContext : global::System.Text.Json.Serialization.JsonSerializerContext
    {
        ...
        ///
        /// </summary>
        public static PromptPartialsSourceGenerationContext Default { get; } = new(DefaultOptions);

        private PromptPartialsSourceGenerationContext(global::System.Text.Json.JsonSerializerOptions options)
            : base(options)
        {
        }
