...
namespace Portkey
{
    public partial class AnalyticsGraphsClient
    {
        ...
        private static readonly global::Portkey.AutoSDKServer[] s_GetAnalyticsGraphsErrorsStacksServers = new global::Portkey.AutoSDKServer[]
        ...
        private static readonly global::Portkey.EndPointSecurityRequirement s_GetAnalyticsGraphsErrorsStacksSecurityRequirement0 =
        ...
        private static readonly global::Portkey.EndPointSecurityRequirement[] s_GetAnalyticsGraphsErrorsStacksSecurityRequirements =
            new global::Portkey.EndPointSecurityRequirement[]
            {                s_GetAnalyticsGraphsErrorsStacksSecurityRequirement0,
            };
        partial void PrepareGetAnalyticsGraphsErrorsStacksArguments(
        ...
        partial void PrepareGetAnalyticsGraphsErrorsStacksRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? spanId,
            string? promptSlug);
        partial void ProcessGetAnalyticsGraphsErrorsStacksResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetAnalyticsGraphsErrorsStacksResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Portkey.GetAnalyticsGraphsErrorsStacksResponse> GetAnalyticsGraphsErrorsStacksAsync(
            string workspaceSlug,
            global::System.DateTime timeOfGenerationMin,
            global::System.DateTime timeOfGenerationMax,
        ...
        {
            var __response = await GetAnalyticsGraphsErrorsStacksAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Portkey.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Portkey.AutoSDKHttpResponse<global::Portkey.GetAnalyticsGraphsErrorsStacksResponse>> GetAnalyticsGraphsErrorsStacksAsResponseAsync(
            string workspaceSlug,
            global::System.DateTime timeOfGenerationMin,
            global::System.DateTime timeOfGenerationMax,
            int? totalUnitsMin = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetAnalyticsGraphsErrorsStacksArguments(
            ...
            var __authorizations = global::Portkey.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetAnalyticsGraphsErrorsStacksSecurityRequirements,
                operationName: "GetAnalyticsGraphsErrorsStacksAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            var __pathBuilder = new global::Portkey.PathBuilder(
                                ...
                                servers: s_GetAnalyticsGraphsErrorsStacksServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetAnalyticsGraphsErrorsStacksRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Portkey.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Portkey.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "getAnalyticsGraphsErrorsStacks",
                                methodName: "GetAnalyticsGraphsErrorsStacksAsync",
                                pathTemplate: "\"/analytics/graphs/errors/stacks\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetAnalyticsGraphsErrorsStacksResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Portkey.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetAnalyticsGraphsErrorsStacksResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Portkey.GetAnalyticsGraphsErrorsStacksResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Portkey.AutoSDKHttpResponse<global::Portkey.GetAnalyticsGraphsErrorsStacksResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Portkey.GetAnalyticsGraphsErrorsStacksResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
