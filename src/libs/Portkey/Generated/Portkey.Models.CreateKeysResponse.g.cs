...
namespace Portkey
{
    ...
    public sealed partial class CreateKeysResponse
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Portkey.JsonConverters.CreateKeysResponseObjectJsonConverter))]
        public global::Portkey.CreateKeysResponseObject? Object { get; set; }
        ...
        public CreateKeysResponse(
            ...
            string? key,
            global::Portkey.CreateKeysResponseObject? @object)
        {
            this.Id = id;
            this.Key = key;
            this.Object = @object;
