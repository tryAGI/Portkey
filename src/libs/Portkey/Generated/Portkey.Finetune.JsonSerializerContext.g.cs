...
namespace Portkey
{
    ...
    public sealed partial class FinetuneSourceGenerationContext : global::System.Text.Json.Serialization.JsonSerializerContext
    {
        ...
        ///
        /// </summary>
        public static FinetuneSourceGenerationContext Default { get; } = new(DefaultOptions);

        private FinetuneSourceGenerationContext(global::System.Text.Json.JsonSerializerOptions options)
            : base(options)
        {
        }
