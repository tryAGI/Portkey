...
namespace Portkey
{
    public partial interface IMcpServersConnectionsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Portkey.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Portkey.AutoSDKHttpResponse<global::Portkey.McpServerConnectionDeleteResponse>> McpServerConnectionsDeleteAsResponseAsync(
            string mcpServerId,
            global::System.Guid? userId = default,
            string? workspaceId = default,
            global::Portkey.AutoSDKRequestOptions? requestOptions = default,
