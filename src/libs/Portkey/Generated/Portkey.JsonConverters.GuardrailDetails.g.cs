...
{
    /// <inheritdoc />
    public class GuardrailDetailsJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Portkey.GuardrailDetails>
    {
        /// <inheritdoc />
        public override global::Portkey.GuardrailDetails Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__jsonProps.Contains("actions.async")) __score1++;
            if (__jsonProps.Contains("actions.deny")) __score1++;
            if (__jsonProps.Contains("actions.on_fail")) __score1++;
            if (__jsonProps.Contains("actions.on_success")) __score1++;
            if (__jsonProps.Contains("checks")) __score1++;
            var __bestScore = 0;
            var __bestIndex = -1;
            if (__score0 > __bestScore) { __bestScore = __score0; __bestIndex = 0; }
            if (__score1 > __bestScore) { __bestScore = __score1; __bestIndex = 1; }

            global::Portkey.GuardrailSummary? summary = default;
            global::Portkey.GuardrailDetailsVariant2? guardrailDetailsVariant2 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
            ...
            var __value = new global::Portkey.GuardrailDetails(
                summary,
