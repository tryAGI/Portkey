            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    var __value = global::Portkey.GetAnalyticsGraphsFeedbacksScoresResponse.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    var __value = await global::Portkey.GetAnalyticsGraphsFeedbacksScoresResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
