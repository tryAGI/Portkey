...
namespace Portkey
{
    public partial class McpServersConnectionsClient
    {
        ...
        private static readonly global::Portkey.AutoSDKServer[] s_McpServerConnectionsDeleteServers = new global::Portkey.AutoSDKServer[]
        ...
        private static readonly global::Portkey.EndPointSecurityRequirement s_McpServerConnectionsDeleteSecurityRequirement0 =
        ...
        private static readonly global::Portkey.EndPointSecurityRequirement[] s_McpServerConnectionsDeleteSecurityRequirements =
            new global::Portkey.EndPointSecurityRequirement[]
            {                s_McpServerConnectionsDeleteSecurityRequirement0,
            };
        partial void PrepareMcpServerConnectionsDeleteArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid? userId,
            ref string? workspaceId,
            ref string mcpServerId);
        partial void PrepareMcpServerConnectionsDeleteRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid? userId,
            string? workspaceId,
            string mcpServerId);
        partial void ProcessMcpServerConnectionsDeleteResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessMcpServerConnectionsDeleteResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Portkey.McpServerConnectionDeleteResponse> McpServerConnectionsDeleteAsync(
            string mcpServerId,
        ...
        {
            var __response = await McpServerConnectionsDeleteAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Portkey.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Portkey.AutoSDKHttpResponse<global::Portkey.McpServerConnectionDeleteResponse>> McpServerConnectionsDeleteAsResponseAsync(
            string mcpServerId,
            global::System.Guid? userId = default,
            string? workspaceId = default,
            global::Portkey.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareMcpServerConnectionsDeleteArguments(
            ...
            var __authorizations = global::Portkey.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_McpServerConnectionsDeleteSecurityRequirements,
                operationName: "McpServerConnectionsDeleteAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Portkey.PathBuilder(
                                ...
                                servers: s_McpServerConnectionsDeleteServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareMcpServerConnectionsDeleteRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Portkey.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Portkey.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "McpServerConnectionsDelete",
                                methodName: "McpServerConnectionsDeleteAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessMcpServerConnectionsDeleteResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Portkey.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessMcpServerConnectionsDeleteResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Portkey.McpServerConnectionDeleteResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Portkey.AutoSDKHttpResponse<global::Portkey.McpServerConnectionDeleteResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Portkey.McpServerConnectionDeleteResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
