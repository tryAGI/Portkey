...
namespace Portkey
{
    ...
    public sealed partial class ResponseInProgressEvent
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Portkey.JsonConverters.ResponseInProgressEventTypeJsonConverter))]
        public global::Portkey.ResponseInProgressEventType Type { get; set; }
        ...
        public ResponseInProgressEvent(
            ...
            global::Portkey.ResponseInProgressEventType type)
        {
