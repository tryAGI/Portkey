...
namespace Portkey
{
    public partial interface IIntegrationsWorkspacesClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Portkey.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Portkey.AutoSDKHttpResponse<global::Portkey.IntegrationWorkspacesResponse>> GetIntegrationsBySlugWorkspacesAsResponseAsync(
            string slug,
            global::Portkey.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default);
    }
