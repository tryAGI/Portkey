...
namespace Portkey
{
    public partial class McpIntegrationsClient
    {
        ...
        private static readonly global::Portkey.AutoSDKServer[] s_McpIntegrationsRetrieveServers = new global::Portkey.AutoSDKServer[]
        ...
        private static readonly global::Portkey.EndPointSecurityRequirement s_McpIntegrationsRetrieveSecurityRequirement0 =
        ...
        private static readonly global::Portkey.EndPointSecurityRequirement[] s_McpIntegrationsRetrieveSecurityRequirements =
            new global::Portkey.EndPointSecurityRequirement[]
            {                s_McpIntegrationsRetrieveSecurityRequirement0,
            };
        partial void PrepareMcpIntegrationsRetrieveArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string mcpIntegrationId);
        partial void PrepareMcpIntegrationsRetrieveRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string mcpIntegrationId);
        partial void ProcessMcpIntegrationsRetrieveResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessMcpIntegrationsRetrieveResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Portkey.McpIntegration> McpIntegrationsRetrieveAsync(
            string mcpIntegrationId,
            global::Portkey.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await McpIntegrationsRetrieveAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Portkey.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Portkey.AutoSDKHttpResponse<global::Portkey.McpIntegration>> McpIntegrationsRetrieveAsResponseAsync(
            string mcpIntegrationId,
            global::Portkey.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareMcpIntegrationsRetrieveArguments(
            ...
            var __authorizations = global::Portkey.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_McpIntegrationsRetrieveSecurityRequirements,
                operationName: "McpIntegrationsRetrieveAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Portkey.PathBuilder(
                                ...
                                servers: s_McpIntegrationsRetrieveServers,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Portkey.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Portkey.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "McpIntegrationsRetrieve",
                                methodName: "McpIntegrationsRetrieveAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessMcpIntegrationsRetrieveResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Portkey.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessMcpIntegrationsRetrieveResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Portkey.McpIntegration.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Portkey.AutoSDKHttpResponse<global::Portkey.McpIntegration>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Portkey.McpIntegration.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
