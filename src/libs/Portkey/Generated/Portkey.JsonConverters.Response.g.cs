...
{
    /// <inheritdoc />
    public class ResponseJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Portkey.Response>
    {
        /// <inheritdoc />
        public override global::Portkey.Response Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            global::Portkey.ModelResponseProperties? modelProperties = default;
            global::Portkey.ResponseProperties? properties = default;
            global::Portkey.ResponseVariant3? responseVariant3 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        modelProperties = global::System.Text.Json.JsonSerializer.Deserialize<global::Portkey.ModelResponseProperties>(__rawJson, options);
                    }
                ...
                else if (__bestIndex == 2)
                {
                    try
                    {
                        responseVariant3 = global::System.Text.Json.JsonSerializer.Deserialize<global::Portkey.ResponseVariant3>(__rawJson, options);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            var __value = new global::Portkey.Response(
                modelProperties,
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.ModelProperties, typeof(global::Portkey.ModelResponseProperties), options);
            }
            ...
            {
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.ResponseVariant3, typeof(global::Portkey.ResponseVariant3), options);
            }
        }
    }
}