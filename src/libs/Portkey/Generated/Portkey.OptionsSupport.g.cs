...
namespace Portkey
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Portkey.AutoSDKRetryOptions Retry { get; set; } = new global::Portkey.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Portkey.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Portkey.IAutoSDKHook>();
        ...
        public global::Portkey.AutoSDKClientOptions AddHook(
            global::Portkey.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Portkey.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Portkey.AutoSDKClientOptions UseAuthorizationProvider(
            global::Portkey.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Portkey.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Portkey.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Portkey.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Portkey.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Portkey.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Portkey.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Portkey.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Portkey.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Portkey.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Portkey.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Portkey.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Portkey.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Portkey.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Portkey.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Portkey.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Portkey.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Portkey.AutoSDKClientOptions clientOptions,
            global::Portkey.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Portkey.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Portkey.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Portkey.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Portkey.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Portkey.IAutoSDKHook, global::Portkey.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Portkey.AutoSDKHookContext context)
        {
