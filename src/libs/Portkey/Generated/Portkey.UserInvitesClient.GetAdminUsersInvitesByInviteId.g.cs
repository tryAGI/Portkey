...
namespace Portkey
{
    public partial class UserInvitesClient
    {
        ...
        private static readonly global::Portkey.AutoSDKServer[] s_GetAdminUsersInvitesByInviteIdServers = new global::Portkey.AutoSDKServer[]
        ...
        partial void PrepareGetAdminUsersInvitesByInviteIdArguments(
            ...
            ref string inviteId);
        partial void PrepareGetAdminUsersInvitesByInviteIdRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string inviteId);
        partial void ProcessGetAdminUsersInvitesByInviteIdResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetAdminUsersInvitesByInviteIdResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Portkey.Invite> GetAdminUsersInvitesByInviteIdAsync(
            string inviteId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            var __pathBuilder = new global::Portkey.PathBuilder(
                                ...
                                servers: s_GetAdminUsersInvitesByInviteIdServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetAdminUsersInvitesByInviteIdRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Portkey.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Portkey.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "getAdminUsersInvitesByInviteId",
                                methodName: "GetAdminUsersInvitesByInviteIdAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetAdminUsersInvitesByInviteIdResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Portkey.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetAdminUsersInvitesByInviteIdResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Portkey.Invite.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Portkey.Invite.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
