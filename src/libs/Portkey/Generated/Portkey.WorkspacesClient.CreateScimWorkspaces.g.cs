...
namespace Portkey
{
    public partial class WorkspacesClient
    {
        ...
        private static readonly global::Portkey.AutoSDKServer[] s_CreateScimWorkspacesServers = new global::Portkey.AutoSDKServer[]
        ...
        private static readonly global::Portkey.EndPointSecurityRequirement s_CreateScimWorkspacesSecurityRequirement0 =
        ...
        private static readonly global::Portkey.EndPointSecurityRequirement[] s_CreateScimWorkspacesSecurityRequirements =
            new global::Portkey.EndPointSecurityRequirement[]
            {                s_CreateScimWorkspacesSecurityRequirement0,
            };
        partial void PrepareCreateScimWorkspacesArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Portkey.CreateScimWorkspacesRequest request);
        partial void PrepareCreateScimWorkspacesRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Portkey.CreateScimWorkspacesRequest request);
        partial void ProcessCreateScimWorkspacesResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateScimWorkspacesResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Portkey.ScimWorkspaceMapping> CreateScimWorkspacesAsync(

            global::Portkey.CreateScimWorkspacesRequest request,
            global::Portkey.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CreateScimWorkspacesAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Portkey.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Portkey.AutoSDKHttpResponse<global::Portkey.ScimWorkspaceMapping>> CreateScimWorkspacesAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateScimWorkspacesArguments(
            ...
            var __authorizations = global::Portkey.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateScimWorkspacesSecurityRequirements,
                operationName: "CreateScimWorkspacesAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Portkey.PathBuilder(
                                ...
                                servers: s_CreateScimWorkspacesServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateScimWorkspacesRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Portkey.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Portkey.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createScimWorkspaces",
                                methodName: "CreateScimWorkspacesAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateScimWorkspacesResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Portkey.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateScimWorkspacesResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Portkey.ScimWorkspaceMapping.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Portkey.AutoSDKHttpResponse<global::Portkey.ScimWorkspaceMapping>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Portkey.ScimWorkspaceMapping.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Portkey.ScimWorkspaceMapping> CreateScimWorkspacesAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Portkey.CreateScimWorkspacesRequest
            {
                WorkspaceId = workspaceId,
                Role = role,
                ScimGroupId = scimGroupId,
                ScimGroupName = scimGroupName,
            };

            return await CreateScimWorkspacesAsync(
                request: __request,
                requestOptions: requestOptions,
