...
namespace Portkey
{
    public partial class AnalyticsGraphsClient
    {
        ...
        private static readonly global::Portkey.AutoSDKServer[] s_GetAnalyticsGraphsFeedbacksWeightedServers = new global::Portkey.AutoSDKServer[]
        ...
        private static readonly global::Portkey.EndPointSecurityRequirement s_GetAnalyticsGraphsFeedbacksWeightedSecurityRequirement0 =
        ...
        private static readonly global::Portkey.EndPointSecurityRequirement[] s_GetAnalyticsGraphsFeedbacksWeightedSecurityRequirements =
            new global::Portkey.EndPointSecurityRequirement[]
            {                s_GetAnalyticsGraphsFeedbacksWeightedSecurityRequirement0,
            };
        partial void PrepareGetAnalyticsGraphsFeedbacksWeightedArguments(
        ...
        partial void PrepareGetAnalyticsGraphsFeedbacksWeightedRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? spanId,
            string? promptSlug);
        partial void ProcessGetAnalyticsGraphsFeedbacksWeightedResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetAnalyticsGraphsFeedbacksWeightedResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Portkey.GetAnalyticsGraphsFeedbacksWeightedResponse> GetAnalyticsGraphsFeedbacksWeightedAsync(
            string workspaceSlug,
            global::System.DateTime timeOfGenerationMin,
            global::System.DateTime timeOfGenerationMax,
        ...
        {
            var __response = await GetAnalyticsGraphsFeedbacksWeightedAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Portkey.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Portkey.AutoSDKHttpResponse<global::Portkey.GetAnalyticsGraphsFeedbacksWeightedResponse>> GetAnalyticsGraphsFeedbacksWeightedAsResponseAsync(
            string workspaceSlug,
            global::System.DateTime timeOfGenerationMin,
            global::System.DateTime timeOfGenerationMax,
            int? totalUnitsMin = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetAnalyticsGraphsFeedbacksWeightedArguments(
            ...
            var __authorizations = global::Portkey.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetAnalyticsGraphsFeedbacksWeightedSecurityRequirements,
                operationName: "GetAnalyticsGraphsFeedbacksWeightedAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            var __pathBuilder = new global::Portkey.PathBuilder(
                                ...
                                servers: s_GetAnalyticsGraphsFeedbacksWeightedServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetAnalyticsGraphsFeedbacksWeightedRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Portkey.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Portkey.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "getAnalyticsGraphsFeedbacksWeighted",
                                methodName: "GetAnalyticsGraphsFeedbacksWeightedAsync",
                                pathTemplate: "\"/analytics/graphs/feedbacks/weighted\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetAnalyticsGraphsFeedbacksWeightedResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Portkey.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetAnalyticsGraphsFeedbacksWeightedResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Portkey.GetAnalyticsGraphsFeedbacksWeightedResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Portkey.AutoSDKHttpResponse<global::Portkey.GetAnalyticsGraphsFeedbacksWeightedResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Portkey.GetAnalyticsGraphsFeedbacksWeightedResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
