...
namespace Portkey
{
    public partial interface IMcpServersConnectionsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Portkey.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Portkey.AutoSDKHttpResponse<global::Portkey.McpServerConnectionsListResponse>> McpServerConnectionsListAsResponseAsync(
            string mcpServerId,
            string? userId = default,
            string? workspaceId = default,
            int? currentPage = default,
