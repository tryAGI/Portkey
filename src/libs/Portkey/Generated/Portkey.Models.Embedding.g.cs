...
namespace Portkey
{
    ...
    public sealed partial class Embedding
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Portkey.JsonConverters.EmbeddingObjectJsonConverter))]
        public global::Portkey.EmbeddingObject Object { get; set; }
        ...
        public Embedding(
            ...
            global::Portkey.EmbeddingObject @object)
        {
            this.Index = index;
