...
namespace Portkey
{
    ...
    public sealed partial class PortkeyClient : global::Portkey.IPortkeyClient, global::System.IDisposable
    {
        ...
        /// </summary>
        public McpServersConnectionsClient McpServersConnections => new McpServersConnectionsClient(HttpClient, baseUri: null, authorizations: Authorizations, options: Options)
        {
            ReadResponseAsString = ReadResponseAsString,
            JsonSerializerContext = JsonSerializerContext,
            AutoSDKServerConfiguration = AutoSDKServerConfiguration,
        ...
        /// <summary>
        /// Creates a new instance of the PortkeyClient with explicit options but no base URL override.
