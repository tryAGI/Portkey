...
namespace Portkey
{
    public partial class WorkspacesMembersClient
    {
        ...
        private static readonly global::Portkey.AutoSDKServer[] s_GetAdminWorkspacesByWorkspaceIdUsersByUserIdServers = new global::Portkey.AutoSDKServer[]
        ...
        private static readonly global::Portkey.EndPointSecurityRequirement s_GetAdminWorkspacesByWorkspaceIdUsersByUserIdSecurityRequirement0 =
        ...
        private static readonly global::Portkey.EndPointSecurityRequirement[] s_GetAdminWorkspacesByWorkspaceIdUsersByUserIdSecurityRequirements =
            new global::Portkey.EndPointSecurityRequirement[]
            {                s_GetAdminWorkspacesByWorkspaceIdUsersByUserIdSecurityRequirement0,
            };
        partial void PrepareGetAdminWorkspacesByWorkspaceIdUsersByUserIdArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string workspaceId,
            ref string userId);
        partial void PrepareGetAdminWorkspacesByWorkspaceIdUsersByUserIdRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string workspaceId,
            string userId);
        partial void ProcessGetAdminWorkspacesByWorkspaceIdUsersByUserIdResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetAdminWorkspacesByWorkspaceIdUsersByUserIdResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Portkey.WorkspaceMember> GetAdminWorkspacesByWorkspaceIdUsersByUserIdAsync(
            string workspaceId,
            string userId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Portkey.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetAdminWorkspacesByWorkspaceIdUsersByUserIdSecurityRequirements,
                operationName: "GetAdminWorkspacesByWorkspaceIdUsersByUserIdAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            var __pathBuilder = new global::Portkey.PathBuilder(
                                ...
                                servers: s_GetAdminWorkspacesByWorkspaceIdUsersByUserIdServers,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Portkey.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Portkey.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "getAdminWorkspacesByWorkspaceIdUsersByUserId",
                                methodName: "GetAdminWorkspacesByWorkspaceIdUsersByUserIdAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetAdminWorkspacesByWorkspaceIdUsersByUserIdResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Portkey.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetAdminWorkspacesByWorkspaceIdUsersByUserIdResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Portkey.WorkspaceMember.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Portkey.WorkspaceMember.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
