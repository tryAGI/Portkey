...
namespace Portkey
{
    ...
    public sealed partial class McpIntegrationsCapabilitiesSourceGenerationContext : global::System.Text.Json.Serialization.JsonSerializerContext
    {
        ...
        ///
        /// </summary>
        public static McpIntegrationsCapabilitiesSourceGenerationContext Default { get; } = new(DefaultOptions);

        private McpIntegrationsCapabilitiesSourceGenerationContext(global::System.Text.Json.JsonSerializerOptions options)
            : base(options)
        {
        }
