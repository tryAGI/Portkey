...
namespace Portkey
{
    public partial class McpIntegrationsCapabilitiesClient
    {
        ...
        private static readonly global::Portkey.AutoSDKServer[] s_McpIntegrationCapabilitiesBulkUpdateServers = new global::Portkey.AutoSDKServer[]
        ...
        private static readonly global::Portkey.EndPointSecurityRequirement s_McpIntegrationCapabilitiesBulkUpdateSecurityRequirement0 =
        ...
        private static readonly global::Portkey.EndPointSecurityRequirement[] s_McpIntegrationCapabilitiesBulkUpdateSecurityRequirements =
            new global::Portkey.EndPointSecurityRequirement[]
            {                s_McpIntegrationCapabilitiesBulkUpdateSecurityRequirement0,
            };
        partial void PrepareMcpIntegrationCapabilitiesBulkUpdateArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string mcpIntegrationId,
            global::Portkey.BulkUpdateMcpIntegrationCapabilities request);
        partial void PrepareMcpIntegrationCapabilitiesBulkUpdateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string mcpIntegrationId,
            global::Portkey.BulkUpdateMcpIntegrationCapabilities request);
        partial void ProcessMcpIntegrationCapabilitiesBulkUpdateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessMcpIntegrationCapabilitiesBulkUpdateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Portkey.McpIntegrationCapabilitiesBulkUpdateResponse> McpIntegrationCapabilitiesBulkUpdateAsync(
            string mcpIntegrationId,
        ...
        {
            var __response = await McpIntegrationCapabilitiesBulkUpdateAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Portkey.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Portkey.AutoSDKHttpResponse<global::Portkey.McpIntegrationCapabilitiesBulkUpdateResponse>> McpIntegrationCapabilitiesBulkUpdateAsResponseAsync(
            string mcpIntegrationId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareMcpIntegrationCapabilitiesBulkUpdateArguments(
            ...
            var __authorizations = global::Portkey.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_McpIntegrationCapabilitiesBulkUpdateSecurityRequirements,
                operationName: "McpIntegrationCapabilitiesBulkUpdateAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Portkey.PathBuilder(
                                ...
                                servers: s_McpIntegrationCapabilitiesBulkUpdateServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareMcpIntegrationCapabilitiesBulkUpdateRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Portkey.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Portkey.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "McpIntegrationCapabilitiesBulkUpdate",
                                methodName: "McpIntegrationCapabilitiesBulkUpdateAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessMcpIntegrationCapabilitiesBulkUpdateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Portkey.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessMcpIntegrationCapabilitiesBulkUpdateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Portkey.McpIntegrationCapabilitiesBulkUpdateResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Portkey.AutoSDKHttpResponse<global::Portkey.McpIntegrationCapabilitiesBulkUpdateResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Portkey.McpIntegrationCapabilitiesBulkUpdateResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await McpIntegrationCapabilitiesBulkUpdateAsync(
                mcpIntegrationId: mcpIntegrationId,
                request: __request,
                requestOptions: requestOptions,
