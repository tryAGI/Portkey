...
namespace Portkey
{
    public partial class McpServersUserAccessClient
    {
        ...
        private static readonly global::Portkey.AutoSDKServer[] s_McpServerUserAccessListServers = new global::Portkey.AutoSDKServer[]
        ...
        private static readonly global::Portkey.EndPointSecurityRequirement s_McpServerUserAccessListSecurityRequirement0 =
        ...
        private static readonly global::Portkey.EndPointSecurityRequirement[] s_McpServerUserAccessListSecurityRequirements =
            new global::Portkey.EndPointSecurityRequirement[]
            {                s_McpServerUserAccessListSecurityRequirement0,
            };
        partial void PrepareMcpServerUserAccessListArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int? page,
            ref int? pageSize,
            ref string? search,
            ref string mcpServerId);
        partial void PrepareMcpServerUserAccessListRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? search,
            string mcpServerId);
        partial void ProcessMcpServerUserAccessListResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessMcpServerUserAccessListResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Portkey.McpServerUserAccessListResponse> McpServerUserAccessListAsync(
            string mcpServerId,
            int? page = default,
        ...
        {
            var __response = await McpServerUserAccessListAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Portkey.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Portkey.AutoSDKHttpResponse<global::Portkey.McpServerUserAccessListResponse>> McpServerUserAccessListAsResponseAsync(
            string mcpServerId,
            int? page = default,
            int? pageSize = default,
            string? search = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareMcpServerUserAccessListArguments(
            ...
            var __authorizations = global::Portkey.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_McpServerUserAccessListSecurityRequirements,
                operationName: "McpServerUserAccessListAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Portkey.PathBuilder(
                                ...
                                servers: s_McpServerUserAccessListServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareMcpServerUserAccessListRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Portkey.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Portkey.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "McpServerUserAccessList",
                                methodName: "McpServerUserAccessListAsync",
                                pathTemplate: "$\"/mcp-servers/{mcpServerId}/user-access\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessMcpServerUserAccessListResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Portkey.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessMcpServerUserAccessListResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Portkey.McpServerUserAccessListResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Portkey.AutoSDKHttpResponse<global::Portkey.McpServerUserAccessListResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Portkey.McpServerUserAccessListResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
