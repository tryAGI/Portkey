...
namespace Portkey
{
    ...
    public sealed partial class CodeInterpreterTextOutput
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Portkey.JsonConverters.CodeInterpreterTextOutputTypeJsonConverter))]
        public global::Portkey.CodeInterpreterTextOutputType Type { get; set; }
        ...
        public CodeInterpreterTextOutput(
            string logs,
            global::Portkey.CodeInterpreterTextOutputType type)
        {
            this.Type = type;
