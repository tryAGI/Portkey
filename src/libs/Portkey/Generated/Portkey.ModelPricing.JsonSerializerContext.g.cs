...
namespace Portkey
{
    ...
    public sealed partial class ModelPricingSourceGenerationContext : global::System.Text.Json.Serialization.JsonSerializerContext
    {
        ...
        ///
        /// </summary>
        public static ModelPricingSourceGenerationContext Default { get; } = new(DefaultOptions);

        private ModelPricingSourceGenerationContext(global::System.Text.Json.JsonSerializerOptions options)
            : base(options)
        {
        }
