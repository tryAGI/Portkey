...
namespace Portkey
{
    public partial class WorkspacesClient
    {
        ...
        private static readonly global::Portkey.AutoSDKServer[] s_GetScimWorkspacesServers = new global::Portkey.AutoSDKServer[]
        ...
        private static readonly global::Portkey.EndPointSecurityRequirement s_GetScimWorkspacesSecurityRequirement0 =
        ...
        private static readonly global::Portkey.EndPointSecurityRequirement[] s_GetScimWorkspacesSecurityRequirements =
            new global::Portkey.EndPointSecurityRequirement[]
            {                s_GetScimWorkspacesSecurityRequirement0,
            };
        partial void PrepareGetScimWorkspacesArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? workspaceId,
            ref string? scimGroupId,
            ref global::Portkey.GetScimWorkspacesRole? role);
        partial void PrepareGetScimWorkspacesRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? workspaceId,
            string? scimGroupId,
            global::Portkey.GetScimWorkspacesRole? role);
        partial void ProcessGetScimWorkspacesResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetScimWorkspacesResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Portkey.GetScimWorkspacesResponse> GetScimWorkspacesAsync(
        ...
        {
            var __response = await GetScimWorkspacesAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Portkey.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Portkey.AutoSDKHttpResponse<global::Portkey.GetScimWorkspacesResponse>> GetScimWorkspacesAsResponseAsync(
            string? workspaceId = default,
            string? scimGroupId = default,
            global::Portkey.GetScimWorkspacesRole? role = default,
            global::Portkey.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetScimWorkspacesArguments(
                httpClient: HttpClient,
                workspaceId: ref workspaceId,
                scimGroupId: ref scimGroupId,
                role: ref role);


            var __authorizations = global::Portkey.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_GetScimWorkspacesSecurityRequirements,
                operationName: "GetScimWorkspacesAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Portkey.PathBuilder(
                                path: "/scim/workspaces",
                                baseUri: ResolveBaseUri(
                                servers: s_GetScimWorkspacesServers,
                                defaultBaseUrl: "https://api.portkey.ai/v1"));
                            __pathBuilder
                                .AddOptionalParameter("workspace_id", workspaceId)
                                .AddOptionalParameter("scim_group_id", scimGroupId)
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetScimWorkspacesRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Portkey.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Portkey.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "getScimWorkspaces",
                                methodName: "GetScimWorkspacesAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetScimWorkspacesResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Portkey.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetScimWorkspacesResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Portkey.GetScimWorkspacesResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Portkey.AutoSDKHttpResponse<global::Portkey.GetScimWorkspacesResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Portkey.GetScimWorkspacesResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
