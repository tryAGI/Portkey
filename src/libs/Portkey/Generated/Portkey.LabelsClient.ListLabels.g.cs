...
namespace Portkey
{
    public partial class LabelsClient
    {
        ...
        private static readonly global::Portkey.AutoSDKServer[] s_ListLabelsServers = new global::Portkey.AutoSDKServer[]
        ...
        partial void PrepareListLabelsArguments(
            ...
            ref int? currentPage,
            ref int? pageSize);
        partial void PrepareListLabelsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int? currentPage,
            int? pageSize);
        partial void ProcessListLabelsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListLabelsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Portkey.ListLabelsResponse> ListLabelsAsync(
        ...
        {
            var __response = await ListLabelsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Portkey.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Portkey.AutoSDKHttpResponse<global::Portkey.ListLabelsResponse>> ListLabelsAsResponseAsync(
            global::System.Guid? organisationId = default,
            string? workspaceId = default,
            string? search = default,
            int? currentPage = default,
                ...
                else
                {
                    await global::Portkey.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                throw new global::Portkey.ApiException<global::Portkey.ErrorResponse>(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListLabelsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Portkey.ListLabelsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Portkey.AutoSDKHttpResponse<global::Portkey.ListLabelsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Portkey.ListLabelsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
