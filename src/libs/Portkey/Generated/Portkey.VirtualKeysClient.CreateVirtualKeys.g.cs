...
namespace Portkey
{
    public partial class VirtualKeysClient
    {
        ...
        private static readonly global::Portkey.AutoSDKServer[] s_CreateVirtualKeysServers = new global::Portkey.AutoSDKServer[]
        ...
        private static readonly global::Portkey.EndPointSecurityRequirement s_CreateVirtualKeysSecurityRequirement0 =
        ...
        private static readonly global::Portkey.EndPointSecurityRequirement[] s_CreateVirtualKeysSecurityRequirements =
            new global::Portkey.EndPointSecurityRequirement[]
            {                s_CreateVirtualKeysSecurityRequirement0,
            };
        partial void PrepareCreateVirtualKeysArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Portkey.CreateVirtualKeysRequest request);
        partial void PrepareCreateVirtualKeysRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Portkey.CreateVirtualKeysRequest request);
        partial void ProcessCreateVirtualKeysResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateVirtualKeysResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Portkey.CreateVirtualKeysResponse> CreateVirtualKeysAsync(

            global::Portkey.CreateVirtualKeysRequest request,
            global::Portkey.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CreateVirtualKeysAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Portkey.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Portkey.AutoSDKHttpResponse<global::Portkey.CreateVirtualKeysResponse>> CreateVirtualKeysAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateVirtualKeysArguments(
            ...
            var __authorizations = global::Portkey.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateVirtualKeysSecurityRequirements,
                operationName: "CreateVirtualKeysAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Portkey.PathBuilder(
                                ...
                                servers: s_CreateVirtualKeysServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateVirtualKeysRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Portkey.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Portkey.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createVirtualKeys",
                                methodName: "CreateVirtualKeysAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateVirtualKeysResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Portkey.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 401)
                            {
                                ...
                                global::Portkey.CreateVirtualKeysResponse2? __value_401 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_401 = global::Portkey.CreateVirtualKeysResponse2.FromJson(__content_401, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Portkey.ApiException<global::Portkey.CreateVirtualKeysResponse2>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateVirtualKeysResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Portkey.CreateVirtualKeysResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Portkey.AutoSDKHttpResponse<global::Portkey.CreateVirtualKeysResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Portkey.CreateVirtualKeysResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Portkey.CreateVirtualKeysResponse> CreateVirtualKeysAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Portkey.CreateVirtualKeysRequest
            {
                Name = name,
                Provider = provider,
                Key = key,
            ...
            return await CreateVirtualKeysAsync(
                request: __request,
                requestOptions: requestOptions,
