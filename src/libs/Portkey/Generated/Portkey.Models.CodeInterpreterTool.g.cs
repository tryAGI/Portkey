...
namespace Portkey
{
    ...
    public sealed partial class CodeInterpreterTool
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Portkey.JsonConverters.CodeInterpreterToolTypeJsonConverter))]
        public global::Portkey.CodeInterpreterToolType Type { get; set; }
        ...
        public CodeInterpreterTool(
            ...
            global::Portkey.CodeInterpreterToolType type)
        {
